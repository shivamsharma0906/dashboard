...
export function AlertsPage() {
  ...
  const handleSendNotification = (alert: AttendanceAlert, type: "student" | "parent") => {
    const message =
      type === "student"
        ? `Dear ${alert.studentName}, your attendance is ${alert.currentAttendance}%. Please improve to meet the 75% requirement.`
        : `Dear Parent, ${alert.studentName}'s attendance is ${alert.currentAttendance}%. Immediate attention required.`
