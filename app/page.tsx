...
export default function LoginPage() {
  ...
  useEffect(() => {
    const isLoggedIn = localStorage.getItem("upasthiti_teacher_logged_in")
    if (isLoggedIn === "true") {
  ...
  useEffect(() => {
    const teachers = localStorage.getItem("upasthiti_teachers")
    if (!teachers) {
      const demoTeachers = [
      ...
      localStorage.setItem("upasthiti_teachers", JSON.stringify(demoTeachers))
    }
  }, [])
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const teachers = JSON.parse(localStorage.getItem("upasthiti_teachers") || "[]")
      const teacher = teachers.find((t: any) => t.email === email && t.password === password)

      if (teacher) {
        localStorage.setItem("upasthiti_teacher_logged_in", "true")
        localStorage.setItem("upasthiti_current_teacher", JSON.stringify(teacher))
        router.push("/teacher-dashboard")
      } else {
